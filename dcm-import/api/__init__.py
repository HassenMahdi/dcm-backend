...
from api.version_2.controllers.api_import_controller import api_import
...
import_api.add_namespace(data_namespace_v2, path='/import/v2/data')
...
import_api.add_namespace(api_import, path='/import/v2/api')
